...
6. A human reviews and merges the PR. The next tick sees `mergedAt` set: the connector sets **`worc:done`** and closes #142 with "Closed by the merged pull request of worc task `gh-142` (<PR URL>)".
